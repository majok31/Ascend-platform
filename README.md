...
<h1>ASCEND PLATFORM</h1>
<h2>We rise by lifting others</h2>

# Project Description 
 Ascend-platform is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [Ascend-Platform Aim](#Ascend's Aim-)        | 📚 Overview Ascend's  goals            |
...
## System Architecture 🏰
<br/>
☝ The Ascend platform consists of three main components:  <br/>
...
#### The front end of Ascend-Platform has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Payment Integration 💳:** Students will purchase and enroll in courses by completing the checkout flow.
- **Cloud-based Media Management ☁️ :** Ascend-Platform uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of Ascend-platform uses several data models and database schemas to manage data, including:
